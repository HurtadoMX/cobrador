    ...
    <View style={[styles.cuadre, styles.cuadreBg]}>
      ...
      <View style={styles.timer}>
        ...
        <View style={styles.parent}>
          <Text style={[styles.text1, styles.maskPosition]}>10/12</Text>
          <Image
      ...
      <View style={[styles.card, styles.cardSpaceBlock]}>
        ...
        <View style={styles.carddescription16}>
          <Text style={[styles.texto, styles.textoTypo]}>
            Ahora estas listo para iniciar tu labor, por favor iniciar tu
      ...
      <Image
        style={[styles.cuadreItem, styles.groupChildLayout]}
        resizeMode="cover"
