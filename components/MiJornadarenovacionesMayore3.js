...
const MiJornadarenovacionesMayore3 = () => {
  return (
    <View
      style={[
    ...
    >
      <View style={[styles.miJornadavendedor, styles.miJornadavendedorLayout]}>
        <Image
          style={[styles.miJornadavendedorChild, styles.frameParentLayout]}
          resizeMode="cover"
...
3.432 pts`}</Text>
            ...
            <View style={styles.separadorForms7}>
              <Image
      ...
      <View style={styles.frameParent4}>
        <View style={styles.separadorFormsParent}>
          <View />
          <View />
          <View />
          <View style={[styles.cardtitle20, styles.title24FlexBox]}>
            <Text style={[styles.title7, styles.titleTypo]}>
              Inicio de supervisión en oficina
            </Text>
          </View>
          <View style={styles.separadorForms6}>
            <Image
          ...
          <View style={styles.carddescription16}>
            <Text style={styles.texto}>
              Tu Supervisor ha decidido que la supervisión inicia en oficina,
              por favor esperalo y una vez vaya a comenzar la evaluación de tu
              vehiculo, solicitale la huella
            </Text>
          </View>
          <View />
          <View style={styles.botonCentradoPpal}>
            <View style={styles.cardFooterDoble}>
              <View style={[styles.button1, styles.buttonBorder]}>
                <Text style={[styles.title8, styles.titleTypo3]}>
                  Entendido
                </Text>
              </View>
              <View style={[styles.button2, styles.buttonBorder]}>
                <Text style={[styles.title, styles.titleTypo3]}>No</Text>
              </View>
            </View>
          </View>
        </View>
        <Image
          style={[styles.groupChild10, styles.groupChildLayout2]}
          resizeMode="cover"
          source={require("../assets/group-1194.png")}
        />
      </View>
    </View>
  );
...
export default MiJornadarenovacionesMayore3;
