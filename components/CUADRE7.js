    ...
    <View style={styles.cuadre}>
      ...
      >
        <View style={styles.sectiontitleYTextoresaltar24}>
          <Text style={[styles.title1, styles.labelClr]}>Cuadre global</Text>
        </View>
        <View />
          ...
          >
            <View style={styles.content}>
              <View style={[styles.main, styles.cardSpaceBlock]}>
                ...
                <View style={[styles.child7, styles.childSpaceBlock]}>
      ...
      >
        <View style={styles.sectiontitleYTextoresaltar24}>
          <Text style={[styles.title1, styles.labelClr]}>
            Gestión en detalle
          </Text>
        </View>
        <View />
        ...
        <View style={styles.formdescription14}>
          <View style={styles.carddescription16}>
            <Text style={[styles.texto, styles.labelClr]}>
              <Text
...
Una vez realizado este paso, solicita el cierre de cuadre.`}</Text>
      ...
      <View style={styles.modal}>
        ...
        <View style={styles.verticalFormSearch}>
          <View style={styles.formItemTitle8}>
            <Text style={[styles.label, styles.labelClr]}>
              Selecciona el tipo de negocio de tu cliente
            </Text>
          </View>
          <View style={[styles.rectangleGroup, styles.childSpaceBlock]}>
            ...
            <View style={styles.searchParent}>
              ...
              />
              <Text style={styles.placeholder8}>
                Busca el colaborador a reemplazar
              </Text>
            </View>
          </View>
        </View>
      ...
      <View style={[styles.groupParent, styles.groupParentLayout]}>
        <View style={[styles.groupView, styles.groupParentLayout]}>
          <View style={styles.cardShadowBox}>
            <LinearGradient
              style={[styles.cardHeader2, styles.cardPosition]}
              locations={[0, 1]}
...
`}</Text>
            ...
            <View style={styles.separadorForms18} />
            <View style={styles.formItemTitleParent}>
              <View style={styles.formItemTitle9}>
                <Text style={styles.label9}>Cupo disponible</Text>
              </View>
              <Text style={[styles.placeholder9, styles.labelClr]}>$5.000</Text>
            </View>
            <View style={styles.separadorForms18} />
          </View>
          <Image
        ...
        <View style={[styles.frameParent2, styles.groupParentLayout]}>
          <View style={styles.cardShadowBox}>
            <LinearGradient
              style={[styles.cardHeader2, styles.cardPosition]}
              locations={[0, 1]}
            ...
            >
              <Text style={[styles.title9, styles.titleClr]}>
                <Text style={styles.mateoAndaluz}>{`Gloria Jimenez
`}</Text>
                <Text style={styles.titleTypo}>ID 9528</Text>
              </Text>
              <Image
                style={[styles.arrowIcon6, styles.arrowIconLayout]}
                resizeMode="cover"
