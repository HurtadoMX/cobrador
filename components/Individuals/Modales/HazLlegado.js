...
const HazLlegado = ({ isVisible, onClose }) => {
        ...
        >
            <View style={styles.overlay}>
                <View style={styles.modalContainer}>
                    <Text style={styles.modalTitle}>Haz LLegado</Text>
                    <View style={styles.lineaFinal}></View>
                    <Text style={styles.modalMessage}>
                        Recuerda antes de descender del vehículo, tener las siguientes precauciones                    
                    </Text>
                    {/* <TextInput
                        style={styles.input}
                    ...
                    <TouchableOpacity onPress={handleRegister} style={styles.registerButton}>
                        <Text style={styles.buttonText}>Iniciar Cuadre</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </Modal>
