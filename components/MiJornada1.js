  ...
  return (
    <View style={styles.miJornada}>
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/subtract31.png")}
      />
...
`}</Text>
        ...
        <View />
        <View style={styles.cardFooterDoble2Layout}>
      ...
      <View style={[styles.groupView, styles.groupViewPosition]}>
        ...
        <View style={[styles.cardtitle20Parent, styles.cardtitle20SpaceBlock]}>
          ...
          <View style={styles.botonCentradoPpal2}>
            <View
              style={[styles.cardFooterDoble2, styles.cardFooterDoble2Layout]}
            >
              <View style={[styles.button4, styles.buttonBorder]}>
                <Text style={[styles.title7, styles.titleTypo]}>
