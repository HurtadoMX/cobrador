  ...
  return (
    <View style={styles.miJornadaSiTrabaja}>
      ...
      <View style={[styles.groupParent, styles.parentPosition]}>
        ...
        <View />
        <View style={styles.tripleButton}>
          <View style={[styles.cardFooterDoble, styles.cardFooterDobleLayout]}>
      ...
      <View style={[styles.cardtitle20Parent, styles.buttonLayout]}>
          ...
          <View style={[styles.verticalFormIteminput, styles.topbarSpaceBlock]}>
            <View style={styles.content}>
              <View style={styles.main}>
                ...
                <View style={[styles.child, styles.buttonLayout]}>
        ...
        <View />
        <View style={styles.cardFooterDobleLayout}>
...
export default MiJornadaSiTrabaja5;
