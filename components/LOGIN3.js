  ...
  return (
    <View style={styles.login}>
      ...
      <View style={styles.groupParent}>
        ...
        <View style={[styles.title14botones, styles.title24FlexBox]}>
          <View style={[styles.title24, styles.title24FlexBox]}>
            <Text style={[styles.title2, styles.labelTypo]}>
              Hay un error en los datos que ingresaste, por favor revisalo y
              vuelve a intentarlo
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.button, styles.buttonFlexBox]}>
          <Text style={[styles.title3, styles.titleTypo1]}>Ingresar</Text>
        </View>
        <View />
        <View />
        <View />
        <View style={[styles.cardFooterDoble, styles.mainSpaceBlock]}>
          ...
          <View style={[styles.button2, styles.buttonFlexBox]}>
            <Text style={[styles.title5, styles.titleTypo1]}>{`Ingresa con
tu huella`}</Text>
          </View>
        </View>
      </View>
