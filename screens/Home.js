...
const Home = () => {
  return (
    <View style={styles.home}>
      ...
      />
      <View style={[styles.card, styles.cardtittleShadowBox]}>
        ...
        <View style={styles.sectiontitleYTextoresaltar24}>
          <Text style={[styles.title1, styles.titleTypo3]}>-06:35 min</Text>
        </View>
      ...
      <View style={styles.sectiontitleYTextoresaltar241}>
        <Text style={[styles.title6, styles.titleTypo3]}>{`Tu crecimiento en el
ranking`}</Text>
        <Image
      ...
      <View style={[styles.cardtittleRankingParent, styles.parentSpaceBlock]}>
      ...
      <View style={[styles.cardtittleRankingGroup, styles.parentSpaceBlock]}>
        <View style={styles.cardtittleRanking}>
          <Image
      ...
      <View style={styles.sectiontitleYTextoresaltar242}>
        <Text style={[styles.title6, styles.titleTypo3]}>
      ...
      <View style={styles.monederoParent}>
        <View style={[styles.monedero, styles.cardtittleShadowBox]}>
...
Has obtenido un 82% de aprobación de parte de tus clientes`}</Text>
        ...
        <View
          style={[
            ...
            styles.flechita057IconPosition,
          ]}
        >
          <Image
      ...
      <View style={styles.sectiontitleYTextoresaltar243}>
        <Text style={[styles.title6, styles.titleTypo3]}>¿Cómo mejorar?</Text>
      </View>
      <View
      ...
      <View style={styles.frameParent4}>
        <View style={styles.portraitOfAttractiveYoungFParent}>
          ...
          <View style={[styles.flechita056Parent, styles.flechita056Position]}>
            ...
            />
            <Image
              style={[styles.flechita057Icon, styles.flechita057IconPosition]}
              resizeMode="cover"
              source={require("../assets/flechita05-7.png")}
            />
          </View>
        </View>
        <View style={[styles.cardtitle20Parent, styles.parentSpaceBlock]}>
          <View style={styles.cardtitle203}>
            <Text style={[styles.title15, styles.titleTypo4]}>
              Vas tarde al ingreso a tu jornada
            </Text>
          </View>
          <View style={[styles.separadorForms1, styles.cardSpaceBlock]}>
            <Image
          ...
          <View style={[styles.cardBody3, styles.tableSpaceBlock]}>
